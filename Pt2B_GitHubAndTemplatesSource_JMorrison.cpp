...
*
* Program develops custom templated functions to perform math on various numeric data types
* Program creates and uses several customized math template functions
